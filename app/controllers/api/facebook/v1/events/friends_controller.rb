class Api::Facebook::V1::Events::FriendsController < ActionController::Base
  ...
  # curl -H "Content-Type: application/json; charset=UTF-8" -H 'Accept: application/json' --data '{"facebook_users_id":"1,2,3","event_date":"2013-01-31"}' --request GET "http://0.0.0.0:3000/api/facebook/v1/events/friends"  
  def index
