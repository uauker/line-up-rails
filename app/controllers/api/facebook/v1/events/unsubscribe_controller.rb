class Api::Facebook::V1::Events::UnsubscribeController < ActionController::Base
  ...
  # curl -H "Content-Type: application/json; charset=UTF-8" -H 'Accept: application/json' --data '{"facebook_user_id":"1","event_date":"2013-01-31"}' --request POST "http://0.0.0.0:3000/api/facebook/v1/events/unsubscribe"  
  def create
